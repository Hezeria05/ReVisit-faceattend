...
def open_user_login():
    window.destroy()
    os.system('python "C:/Users/grace/Desktop/GitReVisit/ReVisit-faceattend/user_login.py"')
...
button_1 = ctk.CTkButton(window, text="Log In", command=open_user_login, width=150, height=42, corner_radius=10, fg_color="#5B757A", hover_color="#719298", font=("Inter", 18, "bold"))
button_1.place(x=310.0, y=307.0)

button_2 = ctk.CTkButton(window, text="Register", command=open_user_register, width=150, height=42, corner_radius=10, fg_color="#5B757A", hover_color="#719298", font=("Inter", 18, "bold"))
