...
from dy_PageUtils import configure_frame, load_image
...
homeimage = load_image('home_icon.png', (131, 36))
home_button = CTkButton (HomebtnF,image=homeimage, text='',
...
visitorimage = load_image('visitor_icon.png', (208, 40))
visitor_button = CTkButton (VisitorbtnF,image=visitorimage, text='',
                            fg_color="white", hover_color="white")
...
residentimage = load_image('list_icon.png', (220, 37))
resident_button = CTkButton (ResidentsbtnF,image=residentimage, text='',
                            fg_color="white", hover_color="white")
...
home_button.configure(command=lambda: indicate(Home_indct, Home_indct, Visitor_indct, Resident_indct))
visitor_button.configure(command=lambda: indicate(Visitor_indct, Home_indct, Visitor_indct, Resident_indct))
resident_button.configure(command=lambda: indicate(Resident_indct, Home_indct, Visitor_indct, Resident_indct))
...
def indicate(selected_indicator, Home_indct, Visitor_indct, Resident_indct):
...
LogbtnF = CTkFrame(Sidebar, fg_color="yellow", corner_radius=0,
                   border_width= 1, border_color="#C1C1C1")
