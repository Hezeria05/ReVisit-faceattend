...
def Home_page(homepage_window, Home_indct, Visitor_indct, Resident_indct, sec_id, logout_btn, home_button, visitor_button, resident_button):
    ...
    Activelbl = CTkLabel(invframe, fg_color="transparent", text="Entered Visitors Today", font=("Arial", 21, "bold"), text_color="#333333")
    ...
    Departedlbl = CTkLabel(outvframe, fg_color="transparent", text="Exited Visitors Today", font=("Arial", 21, "bold"), text_color="#333333")
