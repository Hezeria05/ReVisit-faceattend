...
def on_register_click(homepage_window, Home_indct, Visitor_indct, Resident_indct, sec_id, ret_vname, logout_btn, home_page):
    ...
    def setup_entry_frame():
        if ret_vname is not None:
            ...
            cancelbtn = CTkButton(Entryframe, text="Cancel", width=120, height=48, corner_radius=10, fg_color="#ADCBCF",
                                hover_color="#93ACAF", font=("Inter", 19, "bold"), text_color="#484848", command=lambda: home_page(homepage_window, Home_indct, Visitor_indct, Resident_indct, sec_id, logout_btn))
