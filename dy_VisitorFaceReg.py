...
def on_register_click(homepage_window, Home_indct, Visitor_indct, Resident_indct, sec_id, ret_vname, logout_btn, prev_page):
    ...
    def submit_and_destroy(Entryframe, Existinglabel, scanbtn, entry):
        ...
        scanbtn.configure(command=lambda: face_register(face_name, scanbtn, RegVframe, RCameraFrame, homepage_window, sec_id, Home_indct, Visitor_indct, Resident_indct, cap, on_register_click))
